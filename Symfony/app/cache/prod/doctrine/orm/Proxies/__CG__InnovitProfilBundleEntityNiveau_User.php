 ...
 */
class Niveau_User extends \Innovit\ProfilBundle\Entity\Niveau_User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'idUser', 'idNiveau');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Niveau_User $proxy) {

 ...
 */
class Utilisateur extends \Innovit\ProfilBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'login', 'password', 'nom', 'prenom', 'dateInsc');
        }

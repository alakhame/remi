 ...
 */
class Evolution extends \Innovit\ProfilBundle\Entity\Evolution implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'idUser', 'idMat', 'note');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Evolution $proxy) {

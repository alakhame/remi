...
\t\t\$(function() {
\t\t\t\$( \"#div_droite\" ).load(lk+nom_page[0]+\".html.twig\" );
\t\t});\t\t\t\t\t
\t\tfunction aff(n){
\t\t\t\$(function() {
\t\t\t\t\$( \"#div_droite\" ).load( lk+nom_page[n]+\".html.twig\" );
\t\t\t});
\t\t}
\t</script>
\t<script  src=\"";

...
class __TwigTemplate_5e335e41f6f77dc1003f395b2dc937e30c7a8224995e89a2a8b8981ae8439061 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_0364bb2abf640ce0211903055b0edf3ea077eed55a387a75c9fc04af2ad683c2"] = $this;
        // line 5
...
";
    ...
    ";
        ...
        echo $context["__internal_0364bb2abf640ce0211903055b0edf3ea077eed55a387a75c9fc04af2ad683c2"]->getdisplay_timeline(("timeline_" . $_token_), $this->getAttribute($_collector_, "events"), $_colors_);
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_profile_, "children"))) {
            ...
            ";
                ...
                if (isset($context["events"])) { $_events_ = $context["events"]; } else { $_events_ = null; }
                if (isset($context["colors"])) { $_colors_ = $context["colors"]; } else { $_colors_ = null; }
                echo $context["__internal_0364bb2abf640ce0211903055b0edf3ea077eed55a387a75c9fc04af2ad683c2"]->getdisplay_timeline(("timeline_" . $this->getAttribute($_child_, "token")), $_events_, $_colors_);
                echo "
        ";
            }
...
";
        ...
        if (isset($context["profile"])) { $_profile_ = $context["profile"]; } else { $_profile_ = null; }
        if (isset($context["collector"])) { $_collector_ = $context["collector"]; } else { $_collector_ = null; }
        echo $context["__internal_0364bb2abf640ce0211903055b0edf3ea077eed55a387a75c9fc04af2ad683c2"]->getdump_request_data($_token_, $_profile_, $this->getAttribute($_collector_, "events"), $this->getAttribute($this->getAttribute($this->getAttribute($_collector_, "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                ...
                if (isset($context["child"])) { $_child_ = $context["child"]; } else { $_child_ = null; }
                if (isset($context["collector"])) { $_collector_ = $context["collector"]; } else { $_collector_ = null; }
                echo $context["__internal_0364bb2abf640ce0211903055b0edf3ea077eed55a387a75c9fc04af2ad683c2"]->getdump_request_data($this->getAttribute($_child_, "token"), $_child_, $this->getAttribute($this->getAttribute($_child_, "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($_collector_, "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 451
            $context["__internal_6851533451f0198a6f7967fabdbbe404babfaaee231a0c343b31ba47ef273ade"] = $this;
            // line 452
            echo "                {
                    \"id\": \"";
            // line 453
...
";
            // line 456
            if (isset($context["events"])) { $_events_ = $context["events"]; } else { $_events_ = null; }
            echo $context["__internal_6851533451f0198a6f7967fabdbbe404babfaaee231a0c343b31ba47ef273ade"]->getdump_events($_events_);
            echo "
                    ]
                }
";
